 ...
 * Variables Available:
 * $balances: array(owes, owed and net)
 * $detailed_with_names-> array of [user_id, name, owes and owed
 */
...
<div class="wrap">
    ...
    <div class="splitwise-balance-banner"
        ...
        <div class="splitwise-class-main">
            <p class="splitwise-class-label">
                <?php 
                if($balances['net']>0){
        ...
        <div class="splitwise-balance-summary">
            <div>
                <span class="splitwise-small-level"><?php esc_html_e('You owe', 'splitwise-wp'); ?> </span>
                <span class="splitwise-owe-amount">
                    Rs <?php esc_html_(number_format($balances['owes'], 2)); ?>
                </span>
            </div>
            <div>
                <span class="splitwise-small-level"><?php esc_html_e('Owe to you', 'splitwise-wp'); ?> </span>
                <span class="splitwise-owe-amount">
                    Rs <?php esc_html_(number_format($balances['owed'], 2)); ?>
                </span>
            </div>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right; font-weight:700;">
                        ...
                        <?php else: ?>
                            <span style="color:#8c8f94;"> <?php echo esc_html('setteled', 'splitwise-wp'); ?></span>
                        <?php endif: ?>
                        </td>
                        </tr>
                <?php endforeach; ?>
